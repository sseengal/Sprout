...
with_node \
  ...
  --target "/Users/siddharth/CascadeProjects/Sprout/ios/Pods/Target Support Files/Pods-Sprout/ExpoModulesProvider.swift" \
  --entitlement "/Users/siddharth/CascadeProjects/Sprout/ios/Sprout/Sprout.entitlements" \
  --platform "apple" \
  --packages "@react-native-google-signin/google-signin" "expo" "expo-asset" "expo-blur" "expo-camera" "expo-constants" "expo-file-system" "expo-font" "expo-haptics" "expo-image" "expo-image-picker" "expo-keep-awake" "expo-linking" "expo-router" "expo-splash-screen"
